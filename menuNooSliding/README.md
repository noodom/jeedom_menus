# Menu nooSliding avec fichier de configuration JSon et gestion de navigation par Frame
...
▶️ Avant d'inclure le menu, il faut commencer par les actions suivantes
   ...
   - Créer le scénario d'installation automatique d'un menu noodom, si premier menu généré (disponible [ici](../installation/README.md))
      - Préciser le nom du menu **menuNooSliding** dans le tag **menuName** du scénario (Détail des autres tags dans la procédure pour les autres tags)
...
▶️ Paramétrage du menu (modification du fichier /data/menusNoodom/menuNooSliding/json/perso.json et SEULEMENT ce fichier)
