...
La personnalisation est effectuée depuis un fichier de configuration JSON (**/html/data/menusNoodom/menuJsonFsb33Frame/js/perso.js**).
...
### Avant d'inclure le menu, il faut commencer par les actions suivantes
   ...
   - (Optionnel) Vérifier que le fichier **/js/perso.js** modifié est correct :
...
#### Paramétrage du menu (modification du fichier **/html/montheme/menuJsonFsb33Frame/js/perso.js** et SEULEMENT ce fichier)
