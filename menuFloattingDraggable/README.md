# Menu Floating Draggable avec fichier de configuration JSon et gestion de navigation par Frame
![Menu Floating Draggable](./doc/images/menuFloattingDraggableOn.png)
...
La personnalisation est effectuée depuis un fichier de configuration JSON (**/html/data/menusNoodom/menuFloattingDraggable/json/perso.json**).
...
### Avant d'inclure le menu, il faut commencer par les actions suivantes
   ...
   - Récupérer le template de scénario [nooMenusFilesDownload](../installation/nooMenusFilesDownload.json) ( Tuto détaillé [ici](../installation/README.md) )
        ...
        - Préciser la valeur menuFloattingDraggable pour le tag menuName en début de scénario
        - Exécuter le scénario => Les fichiers du scénario sont bien recopiés
   - Editer le fichier **/html/data/menusNoodom/menuFloattingDraggable/json/perso.json** à l'aide de l'éditeur de fichier :
        - Pour chaque bouton du menu, mettre le libellé du bouton (**label**), le lien vers un design (**link**) et son image (**icon**)
   - (Optionnel) Vérifier que le fichier **/html/data/menusNoodom/menuFloattingDraggable/json/perso.json** modifié est correct :
...
#### Paramétrage du menu (modification du fichier **/html/data/menusNoodom/menuFloattingDraggable/json/perso.json** et SEULEMENT ce fichier)
