...
### Avant d'inclure le menu, il faut commencer par les actions suivantes
   ...
   - Récupérer le template de scénario [nooMenusFilesDownload](../nooMenusFilesDownload.json) ( Tuto détaillé [ici](../installation/README.md) )
        ...
        - Préciser la valeur menuNoo3DAnim pour le tag menuName en début de scénario
...
#### Paramétrage du menu (modification du fichier /data/menusNoodom/menuNoo3DAnim/json/perso.json et SEULEMENT ce fichier)
